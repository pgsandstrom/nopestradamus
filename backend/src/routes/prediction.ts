...
export default (server: Server) => {
  ...
  server.get('/api/v1/prediction/:prediction/participant/:hash', async (req: Request, res: Response, next: Next) => {
    try {
  ...
  server.post('/api/v1/prediction/:prediction/creater/:hash/accept', async (req: Request, res: Response, next: Next) => {
    const predictionHash = req.params.prediction;
    const hash = req.params.hash;
    try {
  ...
  server.post('/api/v1/prediction/:prediction/creater/:hash/deny', async (req: Request, res: Response, next: Next) => {
    const predictionHash = req.params.prediction;
    const hash = req.params.hash;
    try {
  ...
  server.post('/api/v1/prediction/:prediction/participant/:hash/accept/', async (req: Request, res: Response, next: Next) => {
    const predictionHash = req.params.prediction;
    const hash = req.params.hash;
    try {
  ...
  server.post('/api/v1/prediction/:prediction/participant/:hash/deny/', async (req: Request, res: Response, next: Next) => {
    const predictionHash = req.params.prediction;
    const hash = req.params.hash;
    try {
